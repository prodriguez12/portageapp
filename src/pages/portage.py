...
root =r"C:\Users\dragc\Dev\PortageRoads\portage.gdb"
spd_tol = 15
buffr = 20
n_freq = 10
np = 5
...
def algoritmo(root, spd_tol, buffr, n_freq, np, input_data):
    ...
    arcpy.env.workspace = r"C:\Users\dragc\Dev\PortageRoads\portage.gdb"
    ...
    for samp_freq in samp_freq_List:
        ...
        for serie in serie_List:
            gpsData = "data_" + "test2" + "_" + str(samp_freq) + "sec_" + str(serie)
            print gpsData
